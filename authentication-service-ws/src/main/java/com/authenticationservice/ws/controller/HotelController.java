...
import com.authenticationservice.core.mapper.HotelMapper;
...
import com.tui.architecture.metrics.annotation.Timed;
...
public class HotelController {
  ...
  @Timed
  public ResponseEntity<Void> createHotel(@RequestBody HotelDTO dto, UriComponentsBuilder ucBuilder) throws ServiceException {
    try {
  ...
  @Timed
  public ResponseEntity<Void> updateHotel(@PathVariable("id") Integer hotelId, @RequestBody HotelDTO dto) throws ServiceException {
    try {
  ...
  @Timed
  public ResponseEntity<HotelDTO> deleteHotel(@PathVariable("id") Integer hotelId) throws ServiceException {
    try {
  ...
  @Timed
  public ResponseEntity<HotelDTO> getHotel(@PathVariable("id") Integer hotelId) throws ServiceException {
    try {
      HotelEntity entity = hotelService.getById(hotelId);
      if (entity == null) {
  ...
  @Timed
  public ResponseEntity<List<HotelDTO>> getHotels() throws ServiceException {
